...
**Note**: Dynamic commands have known issues, and will likely not be maintained going forward (see [this issue](https://github.com/SilentVoid13/Templater/issues/913) for more details). In most cases the [[Dataview]] plugin is the suggested alternative.
...
← Go to [[Templater - Documentation (4. Commands)|previous page]] | Go to [[Templater - Documentation (4.2. Execution Commands)|next page]] →