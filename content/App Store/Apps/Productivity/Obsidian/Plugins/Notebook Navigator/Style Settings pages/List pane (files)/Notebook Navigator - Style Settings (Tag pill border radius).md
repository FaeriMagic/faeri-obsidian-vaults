...
summary: Corner radius for tag pills.
tags:
...
---
← Go back to [[List pane (files)#Tag pill border radius|Notebook Navigator/Style Settings/List pane (files)]]
## Tag pill border radius
...
> **Default:**
> ```JSON
>   "notebook-navigator-style-settings@@nn-theme-file-tag-border-radius": 10
> ```
