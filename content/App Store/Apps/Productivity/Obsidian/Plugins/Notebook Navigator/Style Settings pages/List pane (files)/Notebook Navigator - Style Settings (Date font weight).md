...
aliases:
  - Date font weight
summary: Font weight for file dates.
tags:
  - style-settings/element/list-pane/files
  - style-settings/style/font/font-weight
---
← Go back to [[List pane (files)#Date font weight|Notebook Navigator/Style Settings/List pane (files)]]
## Date font weight
Font weight for file dates.
...
> **Default:**
> ```JSON
>   "notebook-navigator-style-settings@@nn-theme-file-date-font-weight": 400
> ```
