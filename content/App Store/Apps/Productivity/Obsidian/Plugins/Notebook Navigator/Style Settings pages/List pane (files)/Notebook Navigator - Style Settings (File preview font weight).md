...
aliases:
  - File preview font weight
summary: Font weight for file preview text.
tags:
  - style-settings/element/list-pane/files
  - style-settings/style/font/font-weight
---
← Go back to [[List pane (files)#File preview font weight|Notebook Navigator/Style Settings/List pane (files)]]
## File preview font weight
Font weight for file preview text.
...
> **Default:**
> ```JSON
>   "notebook-navigator-style-settings@@nn-theme-file-preview-font-weight": 400
> ```
