...
summary: File count text color when item is selected.
tags:
...
---
← Go back to [[Navigation pane (folders, tags, shortcuts)#Selected count text color|Notebook Navigator/Style Settings/Navigation pane (folders, tags, shortcuts)]]
## Selected count text color
