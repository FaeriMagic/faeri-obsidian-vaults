...
summary: Border color on custom property pills without custom colors.
tags:
...
---
← Go back to [[Borders#Custom property pill border color|Notebook Navigator/Style Settings/Borders]]
## Custom property pill border color
