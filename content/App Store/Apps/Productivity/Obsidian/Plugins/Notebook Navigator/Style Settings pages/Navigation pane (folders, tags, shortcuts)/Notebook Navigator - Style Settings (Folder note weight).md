...
aliases:
  - Folder note weight
summary: Font weight for folders with notes (overrides all others).
tags:
  - style-settings/element/navigation-pane/folders
  - style-settings/style/font/font-weight
---
← Go back to [[Navigation pane (folders, tags, shortcuts)#Folder note weight|Notebook Navigator/Style Settings/Navigation pane (folders, tags, shortcuts)]]
## Folder note weight
