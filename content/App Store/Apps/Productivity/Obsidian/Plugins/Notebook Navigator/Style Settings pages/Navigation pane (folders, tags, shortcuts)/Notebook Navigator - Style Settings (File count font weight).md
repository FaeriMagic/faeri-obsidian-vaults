...
summary: Font weight for file count badges.
tags:
  - style-settings/element/navigation-pane/file-count
  - style-settings/style/font/font-weight
---
← Go back to [[Navigation pane (folders, tags, shortcuts)#File count font weight|Notebook Navigator/Style Settings/Navigation pane (folders, tags, shortcuts)]]
## File count font weight
