...
summary: Text color for weekday labels (Mon, Tue, Wed...).
tags:
...
---
← Go back to [[App Store/Apps/Productivity/Obsidian/Plugins/Notebook Navigator/Style Settings pages/Calendar/Calendar#Weekday label text color|Notebook Navigator/Style Settings/Calendar]]
## Weekday label text color
