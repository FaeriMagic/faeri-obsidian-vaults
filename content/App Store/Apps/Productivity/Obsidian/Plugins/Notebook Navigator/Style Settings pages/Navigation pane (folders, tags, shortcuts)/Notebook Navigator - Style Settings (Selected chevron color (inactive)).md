...
summary: Expand/collapse arrow color when item is selected and pane is inactive.
tags:
...
---
← Go back to [[Navigation pane (folders, tags, shortcuts)#Selected chevron color (inactive)|Notebook Navigator/Style Settings/Navigation pane (folders, tags, shortcuts)]]
## Selected chevron color (inactive)
