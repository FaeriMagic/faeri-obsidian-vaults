...
summary: Default font weight for folder and tag names.
tags:
...
---
← Go back to [[Navigation pane (folders, tags, shortcuts)#Default folder/tag weight|Notebook Navigator/Style Settings/Navigation pane (folders, tags, shortcuts)]]
## Default folder/tag weight
