...
aliases:
  - List header breadcrumb font weight
summary: Font weight for breadcrumb text in the desktop list header.
tags:
  - untested
...
---
← Go back to [[List pane (files)#List header breadcrumb font weight|Notebook Navigator/Style Settings/List pane (files)]]
## List header breadcrumb font weight
Font weight for breadcrumb text in the desktop list header.
...
> **Default:**
> ```JSON
>   "notebook-navigator-style-settings@@nn-theme-list-heading-breadcrumb-font-weight": 600
> ```
...
> [!question] Unknown what this affects.