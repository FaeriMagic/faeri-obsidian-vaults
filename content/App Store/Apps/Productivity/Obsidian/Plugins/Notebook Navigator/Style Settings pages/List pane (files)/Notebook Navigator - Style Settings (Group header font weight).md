...
aliases:
  - Group header font weight
summary: Font weight for date groups and pinned section.
tags:
  - style-settings/element/list-pane
  - style-settings/element/headers
  - style-settings/style/font/font-weight
---
← Go back to [[List pane (files)#Group header font weight|Notebook Navigator/Style Settings/List pane (files)]]
## Group header font weight
...
> **Default:**
> ```JSON
>   "notebook-navigator-style-settings@@nn-theme-list-group-header-font-weight": 600
> ```
