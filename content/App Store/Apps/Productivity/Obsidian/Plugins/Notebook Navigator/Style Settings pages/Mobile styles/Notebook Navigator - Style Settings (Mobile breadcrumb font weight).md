...
aliases:
  - Mobile breadcrumb font weight
summary: Font weight for mobile header breadcrumb.
tags:
...
---
← Go back to [[Mobile styles#Mobile breadcrumb font weight|Notebook Navigator/Style Settings/Mobile styles]]
## Mobile breadcrumb font weight
Font weight for mobile header breadcrumb.
...
> **Default:**
> ```JSON
>   "notebook-navigator-style-settings@@nn-theme-mobile-list-header-breadcrumb-font-weight": 600
> ```
