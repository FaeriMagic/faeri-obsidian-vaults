...
aliases:
  - Header text color
summary: Text color for month/year and header buttons.
tags:
...
---
← Go back to [[App Store/Apps/Productivity/Obsidian/Plugins/Notebook Navigator/Style Settings pages/Calendar/Calendar#Header text color|Notebook Navigator/Style Settings/Calendar]]
## Header text color
