...
![GitHub release (latest SemVer)](https://camo.githubusercontent.) ![Obsidian Downloads](https://camo.githubusercontent.)

[![ko-fi](https://camo.githubusercontent.com/201ef269611db7eb6b5d08e9f756ab8980df3014b64492770bdf13a6ed924641/68747470733a2f2f6b6f2d66692e636f6d2f696d672f676974687562627574746f6e5f736d2e737667)](https://ko-fi.com/ishizue)
...
3. Configure the required API keys in the plugin settings tab (see [[#Global API Keys]]).
...
**Example:** `[Example Site](https://example.com)` becomes `[Example Site](https://example.com) [(Archived on 2025-04-10)](https://web.archive.org/web/20250410...)`
...
- **Path/Word Patterns:** Only apply during **vault-wide** commands. A note must match _both_ a path pattern AND a word pattern (if both are defined) to be processed.
...
- **Logic:**
    ...
    - If the API indicates a recent (within the `Archive Freshness` setting) snapshot already exists (or rate limit hit), it tries to fetch and insert the URL of the _latest specific snapshot_, but only if no adjacent archive link already exists.
...
- **Logic:** For vault-wide commands, if Path and Word patterns are both defined, a note must match **both** to be included. URL patterns then filter links _within_ those included notes.
#### URL Substitution Rules
...
- **Archive Freshness (Days):** (Standard archive commands only) Only request a _new_ archive if the URL hasn't been archived within this many days. If a recent enough archive exists, the API might return that instead. Set to 0 to always try and create a new archive if one isn't already adjacent to the link. Default: 0.
...
MIT (Archive Box icon is by b farias from [Noun Project](https://thenounproject.com/browse/icons/term/archive-box/ "Archive Box Icons") (CC BY 3.0))