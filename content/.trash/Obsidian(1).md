...
> For vaults synced with iC, the first deletion may create the `.trash` folder without moving the file. A second deletion is required. This is caused by iCloud intercepting the delete operation, not an Obsidian bug.
