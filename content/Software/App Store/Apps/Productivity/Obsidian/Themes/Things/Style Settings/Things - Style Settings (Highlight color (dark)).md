...
---
← Go back to [[App Store/Apps/Productivity/Obsidian/Themes/Things/Style Settings/Style Settings#Highlight color (dark)|Things/Style Settings]]
## Highlight color (dark)
...
> [!warning] 
> The **Highlight color (dark)** settings only take effect when [[Things - Style Settings (Fancy highlighting)|Fancy highlighting]] is turned off. If Fancy highlighting is enabled, it will override your custom highlight colors.
## See also
