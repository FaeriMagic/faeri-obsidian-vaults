...
**Note:** All keyboard shortcuts can be customized. See [[Notebook Navigator - Github README#7 Custom hotkeys|section 7 - Custom hotkeys]] for details on adding VIM-style navigation (h,j,k,l), alternate keys, and modifier combinations.
