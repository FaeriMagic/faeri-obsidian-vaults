...
summary: Default font weight for file names in shortcuts and recent notes.
title: Default file name weight
tags:
  - style-settings/element/navigation-pane
  - style-settings/style/font/font-weight
---
← Go back to [[Navigation pane (folders, tags, shortcuts)#Default file name weight|Notebook Navigator/Style Settings/Navigation pane (folders, tags, shortcuts)]]
## Default file name weight
