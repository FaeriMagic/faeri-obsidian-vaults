...
summary: Border color on tag pills without custom colors in selected files.
...
---
← Go back to [[Borders#Selected tag pill border color|Notebook Navigator/Style Settings/Borders]]
## Selected tag pill border color
