...
summary: Corner radius for file count badges.
...
---
← Go back to [[Navigation pane (folders, tags, shortcuts)#File count border radius|Notebook Navigator/Style Settings/Navigation pane (folders, tags, shortcuts)]]
## File count border radius
...
> - [[Notebook Navigator - Style Settings (Selection background (navitem))|Selection background]]
> - [[Notebook Navigator - Style Settings (Selection background (inactive) (navitem))|Selection background (inactive)]]
> 
> **Default:**
> ```JSON
