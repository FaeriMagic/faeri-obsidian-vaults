---
aliases:
  - Parent folder font weight
summary: Font weight for parent folder path.
title: Parent folder font weight
tags:
  - style-settings/element/list-pane/files
  - style-settings/style/font/font-weight
---
← Go back to [[List pane (files)#Parent folder font weight|Notebook Navigator/Style Settings/List pane (files)]]
## Parent folder font weight
Font weight for parent folder path.
...
> **Default:**
> ```JSON
>   "notebook-navigator-style-settings@@nn-theme-file-parent-font-weight": 400
> ```
