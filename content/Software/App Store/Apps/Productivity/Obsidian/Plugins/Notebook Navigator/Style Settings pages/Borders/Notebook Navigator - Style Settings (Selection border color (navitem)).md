...
summary: Border color on selected navigation items.
title: Selection border color (navitem)
tags:
...
---
← Go back to [[Borders#Selection border color (navitem)|Notebook Navigator/Style Settings/Borders]]
## Selection border color (navitem)
