...
summary: Text color for days within the current month.
...
---
← Go back to [[App Store/Apps/Productivity/Obsidian/Plugins/Notebook Navigator/Style Settings pages/Calendar/Calendar#Day text color (current month)|Notebook Navigator/Style Settings/Calendar]]
## Day text color (current month)
