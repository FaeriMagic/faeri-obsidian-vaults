...
![[image-3.png]]
### Icon
You can add icons alongside tha <span style="color: gray;">[sic]</span> banner or just on their own. To do this run the command "Select icon". This will ad the "icon" property to you note. For the icon you can use images, built-in Lucide icons or any symbols, including emoji:
...
![[image_search.png]]
## Bases support
Most of the properties functional, including coloed <span style="color: gray;">[sic]</span> properties, custom date formats and math rendering also work in bases.
...
```
## Installation
Untill <span style="color: gray;">[sic]</span> this plugin is made availiable <span style="color: gray;">[sic]</span> in the official plugins menu it can be insalled <span style="color: gray;">[sic]</span> via BRAT:
...
## Acknowledgments
This plugin uses a bit of code from the [[Iconic|Iconic plugin]] to be able to add new items to menus.