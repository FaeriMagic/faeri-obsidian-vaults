...
## Contributing
Contributions are welcome! Please see our [development documentation](https://github.com/chrishoward-projects/sourcemode-styling/blob/main/CLAUDE.md) for setup instructions.
### Development Setup
...
## Changelog
See [CHANGELOG.md](https://github.com/chrishoward-projects/sourcemode-styling/blob/main/CHANGELOG.md) for version history and release notes.
## Requirements
- Minimumum verified on Obsidian 1.9.x
## License
MIT License © Chris Howard 2025

[![Buy me a coffee](https://github.com/chrishoward-projects/sourcemode-styling/raw/main/assets/images/bmc-button-small.png)](https://buymeacoffee.com/4e8cu9fzwy)